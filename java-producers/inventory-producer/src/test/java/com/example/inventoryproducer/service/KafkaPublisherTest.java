...
public class KafkaPublisherTest {
    ...
    void send_success_publishes_to_main_topic() {
        ...
        KafkaPublisher publisher = new KafkaPublisher(null, mapper, "inventory_data", "dlq_inventory_data") {
            @Override
        ...
        publisher.send("p1", new Payload("x"));
        assert topics.get(0).equals("inventory_data");
    }
    ...
    void send_failure_goes_to_dlq() {
        ...
        publisher.send("p1", new Payload("x"));
        assert topics.size() >= 2 && topics.get(1).equals("dlq_inventory_data");
    }
